...
class Datatable extends React.Component {
  ...
  componentDidMount() {
    $(this.refs.table).DataTable({ // eslint-disable-line new-cap
  ...
  componentWillUnmount() {
    const table = $(this.refs.table).DataTable(); // eslint-disable-line new-cap
    table.destroy();
  }

  renderColumns(columns) {
    return columns.map(column => (<th>{column.label}</th>));
  }
